...
from cas.cauchy_spectral_mixture import CauchyMixtureKernel
...
class SMKKernel(AdditiveKernel):
    ...
    def __init__(self, num_mixtures1=5, num_mixtures2=4, **kwargs):
        ...
        # Only create corresponding kernel function when num_mixtures > 0
        self.kernels_list = []
        ...
        # If both components are 0, use a default RBF kernel as fallback
        if num_mixtures1 == 0 and num_mixtures2 == 0:
            print("Warning: Both num_mixtures1 and num_mixtures2 are 0, using RBF kernel as fallback")
