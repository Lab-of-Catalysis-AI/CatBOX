...
from cas.localbo_utils import from_unit_cube, latin_hypercube, to_unit_cube
from cas.localbo_utils import onehot2ordinal
from cas.localbo_utils import random_sample_within_discrete_tr_ordinal
        ...
        try:  # RBF/Matern
            ...
            for sub_kernel in base_kernel.kernels:
                if hasattr(sub_kernel, 'mixture_means'):
                    ...
                    weights = (1.0 / (2 * np.pi * mixture_means)).reshape(-1)  # Ensure 1D output
                    break
